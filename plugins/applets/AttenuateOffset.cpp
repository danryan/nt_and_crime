...
#include "../../shim/include/applet_manifests/AttenuateOffset.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/AttenuateOffset.h"
#include "_per_applet_runtime.h"

// Manifest struct and vendor class share the name "AttenuateOffset".
// Alias the manifest so the vendor class name is unambiguous in this TU.
namespace { using ManifestNS = per_applet::AttenuateOffset; }

struct _AppletInstance : public HemiPluginInterface {
    ::AttenuateOffset applet;
