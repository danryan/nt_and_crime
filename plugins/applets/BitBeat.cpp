...
// Arduino.h stubs (constrain, random), OC_core.h, PhzIcons, and HSicons are
// all in scope when BitBeat.h (and its deps peaks_bytebeat.h,
// util/util_history.h) is parsed.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/BitBeat.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/BitBeat.h"
#include "_per_applet_runtime.h"

// Use a distinct alias to avoid shadowing the BitBeat applet class.
using Manifest = per_applet::BitBeat;
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for BitBeat.
}
