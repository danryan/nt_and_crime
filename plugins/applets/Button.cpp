...
#include "../../shim/include/applet_manifests/Button.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Button.h"

namespace { using ManifestNS = per_applet::Button; }
