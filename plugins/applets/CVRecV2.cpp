...
#include "../../shim/include/applet_manifests/CVRecV2.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/CVRecV2.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::CVRecV2; }
...
static void on_aux_button_impl(_NT_algorithm* self) {
    (void)self;
    // CVRecV2 has no aux button action in standalone mode.
}
...
// Test seams: expose OnDataRequest / OnDataReceive for the round-trip test.
