...
#include "../../shim/include/applet_manifests/Carpeggio.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Carpeggio.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::Carpeggio; }
