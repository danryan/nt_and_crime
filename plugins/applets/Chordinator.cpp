...
#include "../../shim/include/applet_manifests/Chordinator.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Chordinator.h"

namespace { using ManifestNS = per_applet::Chordinator; }
