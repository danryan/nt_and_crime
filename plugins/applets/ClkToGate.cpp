...
#include "../../shim/include/applet_manifests/ClkToGate.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/ClkToGate.h"

namespace { using ManifestNS = per_applet::ClkToGate; }
