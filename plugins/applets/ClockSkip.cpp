...
#include "../../shim/include/applet_manifests/ClockSkip.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/ClockSkip.h"

namespace { using ManifestNS = per_applet::ClockSkip; }
