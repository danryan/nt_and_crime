...
#include "../../shim/include/applet_manifests/Combin8.h"
#include "_per_applet_runtime.h"
// Combin8::OnDataRequest uses PackPackables/UnpackPackables. These are not
// in the default per-applet include chain (only HemispheresFactory.h pulls
// them in for the combined build). Include explicitly before the vendor header.
#include "../../shim/include/PackingUtils.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Combin8.h"

namespace { using ManifestNS = per_applet::Combin8; }
...
// Defined here because _AppletInstance is only fully visible in this TU.
