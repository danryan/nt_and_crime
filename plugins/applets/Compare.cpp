...
#include "../../shim/include/applet_manifests/Compare.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Compare.h"

namespace { using ManifestNS = per_applet::Compare; }
