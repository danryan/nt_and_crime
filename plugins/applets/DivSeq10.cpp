...
// all in scope when DivSeq10.h (and its dep util/clkdivmult.h) is parsed.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/DivSeq10.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/DivSeq10.h"
#include "_per_applet_runtime.h"

// Use a distinct alias to avoid shadowing the DivSeq10 applet class.
using Manifest = per_applet::DivSeq10;
...
static void on_aux_button_impl(_NT_algorithm* self) {
    (void)self;
    // DivSeq10 aux button action not forwarded in standalone mode.
}
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for DivSeq10.
}
