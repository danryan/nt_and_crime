...
#include "../../shim/include/applet_manifests/DualQuant.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/DualQuant.h"
#include "_per_applet_runtime.h"

// Manifest struct and vendor class share the name "DualQuant".
// Alias the manifest so the vendor class name is unambiguous in this TU.
namespace { using ManifestNS = per_applet::DualQuant; }
