...
#include "../../shim/include/applet_manifests/EnsOscKey.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/EnsOscKey.h"

namespace { using ManifestNS = per_applet::EnsOscKey; }
