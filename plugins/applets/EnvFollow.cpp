...
#include "../../shim/include/applet_manifests/EnvFollow.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/EnvFollow.h"
#include "_per_applet_runtime.h"

// Manifest struct and vendor class share the name "EnvFollow".
// Alias the manifest so the vendor class name is unambiguous in this TU.
namespace { using ManifestNS = per_applet::EnvFollow; }
