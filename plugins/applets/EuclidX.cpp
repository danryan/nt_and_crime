...
// all in scope when EuclidX.h (and its dep bjorklund.h) is parsed.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/EuclidX.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/EuclidX.h"
#include "_per_applet_runtime.h"

using Manifest = per_applet::EuclidX;
...
static void on_aux_button_impl(_NT_algorithm* self) {
    (void)self;
    // EuclidX has no aux button action.
}
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for EuclidX.
}
