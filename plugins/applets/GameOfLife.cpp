...
#include "../../shim/include/applet_manifests/GameOfLife.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/GameOfLife.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::GameOfLife; }
...
// Test seam: clears the board via OnButtonPress().
