...
#include "../../shim/include/applet_manifests/GateDelay.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/GateDelay.h"
#include "_per_applet_runtime.h"

// Manifest struct and vendor class share the name "GateDelay".
// Alias the manifest so the vendor class name is unambiguous in this TU.
namespace { using ManifestNS = per_applet::GateDelay; }
