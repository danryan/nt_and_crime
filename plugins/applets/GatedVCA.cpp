...
#include "../../shim/include/applet_manifests/GatedVCA.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/GatedVCA.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::GatedVCA; }
...
// GatedVCA's OnDataRequest() always returns 0 (no persistent state).
...
// Test seam: exercises OnEncoderMove for side-effect testing.
