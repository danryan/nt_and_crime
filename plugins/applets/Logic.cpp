...
#include "../../shim/include/applet_manifests/Logic.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Logic.h"
#include "_per_applet_runtime.h"

// Manifest struct and vendor class share the name "Logic"; alias the manifest.
namespace { using ManifestNS = per_applet::Logic; }
