...
#include "../../shim/include/applet_manifests/MultiScale.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/MultiScale.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::MultiScale; }
