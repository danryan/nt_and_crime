// Canonical include order per mass-port spec. Do NOT include hemispheres_shim.h.
...
#include "../../shim/include/applet_manifests/OffsetQuant.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/OffsetQuant.h"
#include "_per_applet_runtime.h"

// Manifest struct name collides with the vendor class name: alias one.
namespace { using ManifestNS = per_applet::OffsetQuant; }
