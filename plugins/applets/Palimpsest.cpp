...
// all in scope when Palimpsest.h is parsed.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/Palimpsest.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Palimpsest.h"
#include "_per_applet_runtime.h"

// Use a distinct alias to avoid shadowing the Palimpsest applet class.
using Manifest = per_applet::Palimpsest;
...
static void on_aux_button_impl(_NT_algorithm* self) {
    (void)self;
    // Palimpsest has no aux button action.
}
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for Palimpsest.
}
