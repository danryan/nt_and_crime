...
#include "../../shim/include/applet_manifests/Pigeons.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Pigeons.h"

namespace { using ManifestNS = per_applet::Pigeons; }
