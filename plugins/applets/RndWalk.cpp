...
#include "../../shim/include/applet_manifests/RndWalk.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/RndWalk.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::RndWalk; }
