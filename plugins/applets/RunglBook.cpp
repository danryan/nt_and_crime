...
#include "../../shim/include/applet_manifests/RunglBook.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/RunglBook.h"

namespace { using ManifestNS = per_applet::RunglBook; }
