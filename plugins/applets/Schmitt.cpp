...
#include "../../shim/include/applet_manifests/Schmitt.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Schmitt.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::Schmitt; }
