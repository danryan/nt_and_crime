...
#include "../../shim/include/applet_manifests/ShiftGate.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/ShiftGate.h"
#include "_per_applet_runtime.h"

// Manifest struct and vendor class share the name "ShiftGate".
// Alias the manifest so the vendor class name is unambiguous in this TU.
namespace { using ManifestNS = per_applet::ShiftGate; }
