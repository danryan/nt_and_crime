...
#include "../../shim/include/applet_manifests/Shredder.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Shredder.h"

namespace { using ManifestNS = per_applet::Shredder; }
