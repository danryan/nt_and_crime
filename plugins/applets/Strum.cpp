// HEM_BURST_SPACING_MIN/MAX are defined in vendor Burst.h.  Strum.h uses
// them without including Burst.h, so we define them here before the vendor
// Strum header.  Values match Burst.h verbatim.
#ifndef HEM_BURST_SPACING_MIN
#define HEM_BURST_SPACING_MIN 8
#endif
#ifndef HEM_BURST_SPACING_MAX
#define HEM_BURST_SPACING_MAX 500
#endif

#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/Strum.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Strum.h"

namespace { using ManifestNS = per_applet::Strum; }
