...
// SwitchSeq: four embedded MiniSeq sequences; mode + CV selects active one.
// MiniSeq.h indexes OC::user_patterns[0..3] so NT_HEM_NEED_USER_PATTERNS must
// be defined before any include to instantiate the 256-byte storage in this TU.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/OC_patterns.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/SwitchSeq.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/SwitchSeq.h"
#include "_per_applet_runtime.h"

using Manifest = per_applet::SwitchSeq;
...
static void on_aux_button_impl(_NT_algorithm* self) {
    (void)self;
    // SwitchSeq has no aux button action.
}
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for SwitchSeq.
}
