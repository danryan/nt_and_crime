...
// all in scope when TB3PO.h is parsed.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/TB3PO.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/TB3PO.h"
#include "_per_applet_runtime.h"

// Use a distinct alias to avoid shadowing the TB_3PO applet class.
using Manifest = per_applet::TB3PO;
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for TB3PO.
}
