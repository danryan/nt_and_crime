...
#include "../../shim/include/applet_manifests/TLNeuron.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/TLNeuron.h"
#include "_per_applet_runtime.h"

namespace { using ManifestNS = per_applet::TLNeuron; }
