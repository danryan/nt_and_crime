...
#include "../../shim/include/applet_manifests/Trending.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Trending.h"

namespace { using ManifestNS = per_applet::Trending; }
