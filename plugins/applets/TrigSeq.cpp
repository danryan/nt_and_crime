...
// Arduino.h stubs (constrain), and PhzIcons are all in scope when TrigSeq.h
// is parsed.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/TrigSeq.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/TrigSeq.h"
#include "_per_applet_runtime.h"

// Use a distinct alias to avoid shadowing the TrigSeq applet class.
using Manifest = per_applet::TrigSeq;
...
static void on_aux_button_impl(_NT_algorithm* self) {
    (void)self;
    // TrigSeq has no aux button action.
}
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for TrigSeq.
}
