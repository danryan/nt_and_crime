...
// all in scope when TwoRings.h is parsed.
#include "../../shim/include/HemisphereApplet.h"
#include "../../shim/include/HemiPluginInterface.h"
#include "../../shim/include/applet_manifests/TwoRings.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/TwoRings.h"
#include "_per_applet_runtime.h"

using Manifest = per_applet::TwoRings;
...
static void parameterChanged_impl(_NT_algorithm* /*self*/, int /*p*/) {
    // No applet-specific parameter remapping for TwoRings.
}
