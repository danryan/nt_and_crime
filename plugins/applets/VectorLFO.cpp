...
// or the vendor applet headers. VectorLFO needs the vector-osc dep headers
...
#include "../../vendor/O_C-Phazerville/software/src/applets/VectorLFO.h"
...
static void step_impl(_NT_algorithm* self, float* busFrames, int numFramesBy4) {
    auto* inst = static_cast<_AppletInstance*>(self);
    per_applet_runtime::populate_frame_from_bus<AppletManifest>(self, busFrames, numFramesBy4);
