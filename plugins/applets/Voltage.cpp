...
#include "../../shim/include/applet_manifests/Voltage.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Voltage.h"

namespace { using ManifestNS = per_applet::Voltage; }
