...
#include "../../shim/include/applet_manifests/Xfader.h"
#include "_per_applet_runtime.h"
#include "../../vendor/O_C-Phazerville/software/src/applets/Xfader.h"

namespace { using ManifestNS = per_applet::Xfader; }
