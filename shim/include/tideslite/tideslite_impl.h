#pragma once
// Verbatim copy of vendor/O_C-Phazerville/software/src/tideslite.cpp
// wrapped as a header-only include so the dep test binary can link
// ProcessSample / WarpPhase / ShapePhase without a Makefile change.
// Include this exactly once in any translation unit that needs the
// tideslite implementation (the dep test does; applet users link via
// Hemispheres.host.o once EbbAndLfo / WTVCO are registered).
#include "tideslite.h"
