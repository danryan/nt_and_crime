#pragma once
// Shim copy of vendor/O_C-Phazerville/software/src/util/clkdivmult.h.
// OC::CORE::ticks is provided by shim/include/OC_core.h.
// constrain() is provided by shim/include/Arduino.h.
//
// Guard against double-definition: vendor applets include ../util/clkdivmult.h
// via relative path (bypassing #pragma once on this file). The named guard
// below causes the vendor file's definitions to be skipped when our shim has
// already defined them.
#ifndef UTIL_CLKDIVMULT_H_DEFINED
#define UTIL_CLKDIVMULT_H_DEFINED
#include "OC_core.h"
#include "Arduino.h"
...
#endif // UTIL_CLKDIVMULT_H_DEFINED
